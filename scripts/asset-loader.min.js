...
/** Varible contador/apuntador para el arreglo assetsBundle para asignar cada recurso del juego **/
var i = 0;
/** Guarda las rutas a los archivos de carga en orden a como se llame a la funcion P6f[n32.t38(75)][n32.t38(67)] **/
/** EVITE CAMBIAR EL ORDEN DE LAS UBICACIONES **/
assetsBundle = [
	'sprites/poki-icon.png',
	'sprites/poki-logo.png',
	'sprites/chicken.png',
	'sprites/hipster-1.png',
	'sprites/hipster-2.png',
	'sprites/hipster-3.png',
	'sprites/whale-1.png',
	'sprites/whale-2.png',
	'sprites/whale-3.png',
	'sprites/hipster-whale.png',
	'sprites/crossy-road-logo.png',
	'sprites/interface.png',
	'fonts/8-bit-wonder.png',
	'fonts/8-bit-wonder-yellow.png',
	'sprites/particles.png',
	'sprites/trex.png',
	'sprites/upsell-app-store.png',
	'sprites/upsell-google-play.png',
	'assets/upsell-phone.png'
];
Z3ss.e38 = function() {
    var G38 = 2;
    for (; G38 !== 1; ) {
    ...
    59: function(D6f, j6f) {
        ...
        P6f[n32.t38(75)][n32.t38(67)] = function(B0T) {
            ...
            P6f[n32.t38(52)](function(b0T) {
				...
				/** El motor de carga de recursos llama la funcion y se asigna segun el valor de i lo que apunte a assetsBundle **/
				L0T[n32.t38(11)] = assetsBundle[i];
				
				/** Actuliza el valor de i cada vez que se llama a la funcion para la carga del siquinte .png **/
				i++;
				
				/** Se asigna a la varible el parametro 'B0T' de referencia al .png originalmente en el codigo **/
                /** L0T[n32.t38(11)] = B0T; **/
            });
        }
        ;
